import { TrendingUp, Clock, ShoppingCart, FileText, DollarSign, Users } from "lucide-react";
...
import { StatsCard } from "../molecule/stats-card";
...
export default function AdminDashboardTemplate() {
	const stats = [
		...
		},
		{
			...
			description: {
				subtitleValue: "+12%",
				subtitleText: "from previous month",
			},
	...
	return (
		<div className="space-y-4">
			...
			<div className="grid gap-4 md:grid-cols-5 ">
				<Card className="md:col-span-3 h-75">
					<CardHeader>
						<CardTitle>
							Action Items{" "}
